...
public class  GraphAlgorithms {
    ...
    public static <T> Map<Vertex<T>, Integer> dijkstras(Vertex<T> start,
        ...
        while (!priorityQueue.isEmpty()) {
            VertexDistance<T> tmp = priorityQueue.remove();
            for (VertexDistance<T> vd
                ...
                if (result.get(vd.getVertex()) > distance) {
                    ...
                    priorityQueue.add(new VertexDistance<>(vd.getVertex(), distance));
                }
            }
        }
        return result;
    ...
    public static <T> Set<Edge<T>> kruskals(Graph<T> graph) {
        ...
        while (!priorityQueue.isEmpty() && graphSize > 1) {
            ...
            if (!ds.find(u).equals(ds.find(v))) {
                ...
                Edge<T> reverseEdge = new Edge<>(vVertex, uVertex, edge.getWeight());
                mst.add(reverseEdge);
                graphSize--;
            }
        }
